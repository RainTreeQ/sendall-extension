...
- **落地页**：[https://sendol.chat](https://sendol.chat) - 功能展示、定价、安装入口
- **设计系统**：`/design-system` - 内部组件文档

本地预览：
```bash
npm run dev --prefix app
# 打开 http://localhost:5173/（落地页）或 http://localhost:5173/design-system
```
