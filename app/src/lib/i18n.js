const FALLBACK_MESSAGES = {
  en: {
    ...
    broadcast_continues_background: 'Broadcast still running in background… ($1 tabs)',
    status_sent: '$1 — Sent',
  ...
  zh_CN: {
    ...
    broadcast_progress_line: '进度 $1/$2 · 成功 $3 · 失败 $4 · 处理中 $5',
    broadcast_continues_background: '广播仍在后台处理中…（$1 个标签页）',
    status_sent: '$1 — 已发送',
