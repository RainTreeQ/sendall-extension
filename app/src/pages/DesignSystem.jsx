...
const COPY = {
  "zh-CN": {
    ...
    backLanding: "返回落地页",
    title: "设计系统",
    intro: "当前规范直接映射 SendAll popup：中性黑白灰、圆角列表、底部悬浮输入区、低噪声动效。",
  ...
  en: {
    ...
    title: "Design System",
    intro: "This spec maps directly to SendAll popup: neutral grayscale, rounded list items, bottom floating input area, low-noise motion.",
